...
// Bubble Tea model for AI multi-selection
...
func (m aiSelectModel) View() string {
	...
	for i, choice := range m.choices {
		...
		s += cursor + checkbox + " " + style.Render(fmt.Sprintf("%-10s", choice)) + dimStyle.Render(" - "+cfg.displayName) + "\n"
	}
